...
import raven.application.form.xdd;
 ...
 * @author Raven
 */
public class classXDD extends JPanel {

    public static void setMenuFull(boolean menuFull) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    private final xdd menu;
    ...
    private void init() {
        ...
        selectedButton.addActionListener((ActionEvent e) -> {
            ...
            show(classXDD.this, (int) getWidth() + UIScale.scale(4), y);
        });
